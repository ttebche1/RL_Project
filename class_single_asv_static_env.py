...
class SingleASVStaticEnv(gym.Env):
    ...
    def get_obs(self):
        ...
        Return:
            observation (numpy array):
                agent's x coordinate, true
                agent's y coordiante, true
        ...
        return np.array([
            ...
            self.d_true_dist_to_target_vec[0],
            self.d_true_dist_to_target_vec[1]],
        dtype=np.float32)
    ...
    def reset(self, *, seed=None, options=None):
        ...
        self.d_true_dist_to_target_vec = np.array([0.0, 0.0], dtype=np.float32)
    ...
    def step(self, action: np.ndarray):
        ...
        self.d_true_dist_to_target_vec = self.true_agent_loc_vec - prev_true_agent_loc_vec
